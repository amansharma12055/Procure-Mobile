...
exports.config = {
    ...
    mochaOpts: {
        ui: 'bdd',
        timeout: 300000,
        bail: false // Adjust Mocha options as needed (e.g., reporters)
    },
    //
     ...
     * @param {String} _cid worker id (e.g. 0-0)
     */
     ...
     */
      before: function (_capabilities: any, _specs: any) {
        console.debug("Inside Before function *****************************************************");
      //  const fkill = require('fkill');
       // fkill(':4723', { force: true }).catch(() => {});
    ...
    onComplete: function() {
        ...
        const generation = allure(['generate', './'+reportPath, '--clean'])
